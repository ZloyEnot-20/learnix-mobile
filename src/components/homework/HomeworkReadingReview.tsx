...
import { buildReadingReviewItems, type ReadingReviewItem } from "../../lib/homework-review"
import { formatShortDate, scoreColor } from "../../lib/utils"
import { colors, radius, shadow, spacing } from "../../theme/tokens"
import { HomeworkReviewShell } from "./HomeworkReviewShell"

interface HomeworkReadingReviewProps {
...
export function HomeworkReadingReview({
  test,
  attempt,
  title,
  subject = "reading",
  ...
  const items = useMemo(
    () => buildReadingReviewItems(test, attempt),
    [test, attempt],
  )
